			...
			<div class="input-form col-md-12 mx-auto">
				...
				<form class="validation-form" novalidate action="#" method="post">
					...
					<div class="mb-3">
						...
						<input type="file" id="movie_poster" class="form-control" required />
						<div class="invalid-feedback">포스터를 선택해주세요.</div>
					</div>
					<div class="mb-3">
						<label for="movie_stillCut1">스틸컷1</label> 
						<input type="file" id="movie_stillCut1" class="form-control" required />
						<div class="invalid-feedback">스틸컷을 선택해주세요.</div>
					</div>
					<div class="mb-3">
						<label for="movie_stillCut2">스틸컷2</label> 
						<input type="file" id="movie_stillCut2" class="form-control" />
					</div>
					<div class="mb-3">
						<label for="movie_stillCut3">스틸컷3</label> 
						<input type="file" id="movie_stillCut3" class="form-control" />
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<textArea id="movie_story" class="form-control" required></textArea>
