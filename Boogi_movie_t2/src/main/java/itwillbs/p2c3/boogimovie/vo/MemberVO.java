...
public class MemberVO {
	...
	public MemberVO(String id, String name, String pwd, String email, String tel, String addr, String movie_genre,
			String status, String my_theater, String point, String birth, Date reg_date, Date withdraw_date) {
		super();
		this.id = id;
		this.name = name;
		this.pwd = pwd;
	...
	public String toString() {
		return "MemberVO [id=" + id + ", name=" + name + ", pwd=" + pwd + ", email=" + email + ", tel=" + tel
				...
				+ my_theater + ", point=" + point + ", birth=" + birth + ", reg_date=" + reg_date + ", withdraw_date="
				+ withdraw_date + "]";
	}
