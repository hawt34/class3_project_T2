		...
		<div class="btn-group-vertical">
			...
			<div class="btn-group dropright">
				...
				<div class="dropdown-menu">
					<!-- 마우스 오버 후 서브메뉴 -->
					<a class="dropdown-item" href="${pageContext.request.contextPath}/admin/admin_member/admin_member.jsp">회원정보관리</a> 
					<a class="dropdown-item" href="${pageContext.request.contextPath}/admin/admin_member/admin_review.jsp">리뷰관리</a> 
					<a class="dropdown-item" href="${pageContext.request.contextPath}/admin/admin_member/admin_reserve.jsp">예매관리</a>
				</div>
			</div>
			<div class="btn-group dropright">
				<button type="button" class="btn" data-toggle="dropdown">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="${pageContext.request.contextPath}/admin/admin_movie/admin_movie.jsp">영화정보관리</a> 
					<a class="dropdown-item" href="${pageContext.request.contextPath}/admin/admin_movie/admin_moviePlan.jsp">상영일정관리</a>
				</div>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" data-toggle="dropdown">
