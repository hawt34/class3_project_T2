		...
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				<form class="validation-form" novalidate action="admin_booth_pro" method="post">
					<div class="mb-3">
						<label for="movie_code">극장 지점명</label> 
						<input type="text" id="movie_code" name="theater_name" class="form-control" required />
						<div class="invalid-feedback">극장 지점명 입력해주세요.</div>
					</div>
					<div class="mb-3">
						<label for="movie_code">상영관 번호</label> 
						<input type="text" id="movie_code" name="screen_num" class="form-control" required />
					...
					<div class="mb-3">
						...
						최대 행(row, 숫자)<input type="text" id="movie_createDate" name="screen_seat_row" class="form-control" required style="width: 300px;"/>
						최대 열(col, 알파벳)<input type="text" id="movie_createDate" name="screen_seat_col" class="form-control" required style="width: 300px;" />
