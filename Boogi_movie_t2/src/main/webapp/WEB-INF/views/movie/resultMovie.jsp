...
<body>
	...
	<div id="wrap">
		<article>
			<h1>검색하신 영화 검색어는 "${param.searchKeyword}" 이고 검색결과는 ${movieResult}개 	입니다.</h1></article>
		<section>
			<div class="nowMovie">
			...
			<div class="list">
			<c:forEach var="movie" items="${movieList}" varStatus="loop" begin="0">
    		<div class="movie">
			...
			<div class="more">
				<button id="moreMoviesBtn" type="button" class="btn btn-outline-primary">검색결과 더보기</button>
			</div>
