	...
	<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				<h4 class="mb-4">공지사항수정</h4>
				<form class="validation-form" novalidate action="#" method="post">
					<div class="mb-3">
						<label for="movie_director">공지사항작성자</label> 
						<input type="text" id="movie_director" class="form-control" required />
						<div class="invalid-feedback">감독을 입력해주세요.</div>
					</div>
					<div class="mb-3">
						<label for="movie_code">공지사항코드</label> 
						<input type="text" id="movie_code" class="form-control" required />
						<div class="invalid-feedback">공지사항코드를 입력해주세요.</div>
					</div>
					<div class="mb-3">
						<label for="movie_name">공지사항명</label> 
						<input type="text" id="movie_name" class="form-control" required />
						<div class="invalid-feedback">공지사항명을 입력해주세요.</div>
					</div>
					<div class="mb-3">
						<label for="movie_name">공지사항이미지</label> 
						<input type="text" id="movie_name" class="form-control" required />
						<div class="invalid-feedback">공지사항이미지를 입력해주세요.</div>
					</div>
					<div class="mb-3">
						<label for="movie_story">공지사항내용</label> 
