...
<body>
	...
	<div id="wrap">
		...
		<article>
			<video src="${pageContext.request.contextPath}/resources/home.mp4" autoplay muted>
			</video>
		</article>
		<section>
			<div class="content">
				...
				<div class="list">
					...
					<div class="movie">
						<img src="${pageContext.request.contextPath}/resources/images/movie_2.jpg"> 팬더
					</div>
					<div class="movie">
			...
			<div id="carouselExample" class="carousel slide">
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						...
						<div class="lank">
						 <img src="${pageContext.request.contextPath}/resources/images/movie_1st.png">
<!-- 						 대충해놓음 -->
