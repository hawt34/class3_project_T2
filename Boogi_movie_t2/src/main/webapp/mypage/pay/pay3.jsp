...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/myp_pay3.css">
			...
			<div class="col-md-2 box1">
				...
				<hr>
					...
					<div class="tab-content" id="myTabContent">
						...
						<div class="col-md-10 tab-pane fade box3" id="myreview" role="tabpanel"aria-labelledby="myreview-tab">
							<table class="table2 table table-hover" >
							  <thead>
							    <tr>
							      <th scope="col">#</th>
